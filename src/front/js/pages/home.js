  ...
  return (
    <div className="container-fluid py-3">
      ...
      <div id="seccion1" className="container-fluid position-relative">
        <img src={carrousel1Url} className="img-fluid" alt="bullbear" style={{maxHeight: "600px", height: "auto", width:"100%"}}/>
        
          {/* <h1>
            Tu camino al éxito financiero empieza aquí
          </h1> */}
          
          <button type="button" className="btn btn-outline-primary position-absolute bottom-0 start-50 translate-middle">
            Ir a registro
          </button>
        </div>
