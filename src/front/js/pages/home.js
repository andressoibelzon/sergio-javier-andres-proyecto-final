  ...
  return (
    <div className="">
      <div id="seccion1" className=" ">
        <img src={carrousel1Url} className="img-fluid mb-5" alt="bullbear" />
      ...
      <div className="d-flex justify-content-center align-item-center mt-2">
        <Link to="/register">
          <button
            type="button"
            className="btn-primary btn-lg py-3 px-3 my-3 border shadow "
          >
            Accede ya!
          </button>
        </Link>
      ...
      <h2 className="container d-flex justify-content-center fw-bold mb-5 mt-5">
      ...
      <div className="mb-5">
        <h3 className="container d-flex justify-content-center mb-5">
          {" "}
          Accede a los gráficos más relevantes totalmente actualizados.
        </h3>
        <div id="container-carrusel" className="container shadow carousel-fade">
          <div
      ...
      <div style={{ position: "relative", zIndex: "1" }}>
        <h3 className="container d-flex justify-content-center mb-5 mt-5">
          {" "}
          Actualízate con las noticias del día
        </h3>
        <img src={homeChartsUrl} className="img-fluid mt-5 mb-5" alt="Imagen" />
      ...
      <div className="fixed-top d-flex justify-content-end top-50 translate-middle-y" style={{ width: "212px", left: "83%" }}>
        <iframe // indice
          width="212px"
          height="380px"
          data-widget-name=""
      ...
      <div className="px-5 mt-5">
        <p>
          ¡Pronto lanzaremos nuestras señales de mercado de compra y venta!
          Obtén una ventaja competitiva en tus inversiones con nuestra
          experiencia y análisis de mercado en tiempo real. ¡Mantente atento
          para más detalles!
        </p>
      </div>
    </div>
