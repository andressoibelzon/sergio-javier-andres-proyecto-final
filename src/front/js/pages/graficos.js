...
export const Graficos = () => {
    ...
    return (
        ...
        <div className="container">
            ...
            <h3 className="d-flex justify-content-center my-5">Información en tiempo real</h3>
            ...
            <h3 className="d-flex justify-content-center my-5">Cryptos - Materias Primas - Fondos</h3>
